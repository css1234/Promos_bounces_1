...
# DEBUG = os.getenv('DEBUG', 'False').lower() in ['true', '1']  # Strict check for DEBUG
DEBUG = True
...
REST_FRAMEWORK = {
    ...
    'PAGE_SIZE': 10,  # Default if page_size is not specified
...
SPECTACULAR_SETTINGS = {
    ...
    'VERSION': '1.0.0',
    'SERVE_INCLUDE_SCHEMA': True,  # Ensure schema is included for Swagger
}
